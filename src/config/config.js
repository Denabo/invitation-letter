const config = {
  data: {
    ...
    gifts: {
      text: "Мы будем рады любому знаку внимания, но удобнее всего для нас — конверт. А если думаете о цветах: вместо букета будем благодарны за любую сумму на декор — они украсят столы прямо на празднике.",
    },
    audio: {
